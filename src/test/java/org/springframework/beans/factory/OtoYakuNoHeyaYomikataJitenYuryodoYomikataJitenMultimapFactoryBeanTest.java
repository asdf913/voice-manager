...
class OtoYakuNoHeyaYomikataJitenYuryodoYomikataJitenMultimapFactoryBeanTest {
	...
	private static Method METHOD_TEST_AND_APPLY, METHOD_LENGTH, METHOD_GET_UNICODE_BLOCKS, METHOD_TO_MULTI_MAP1,
			...
			METHOD_TO_MULTI_MAP6, METHOD_TO_MULTI_MAP7, METHOD_TO_MULTI_MAP8, METHOD_TO_MULTI_MAP9,
			METHOD_TO_MULTI_MAP10, METHOD_TO_ENTRY, METHOD_OR_ELSE, METHOD_MAX, METHOD_MIN, METHOD_MAP_TO_INT = null;
	...
	static void beforeAll() throws NoSuchMethodException {
		...
		//
		(METHOD_TO_MULTI_MAP9 = clz.getDeclaredMethod("toMultimap9", String.class, String.class)).setAccessible(true);
		//
		(METHOD_TO_MULTI_MAP10 = clz.getDeclaredMethod("toMultimap10", String.class, String.class)).setAccessible(true);
		//
		...
		if (cellSet != null && cellSet.iterator() != null) {
			...
			for (final Cell<String, String, String> cell : cellSet) {
				...
				if (cell == null) {
					...
					//
				Assertions.assertEquals(cell.getValue(),
						Util.toString(toMultimap4(cell.getRowKey(), cell.getColumnKey())), Util.toString(cell));
				//
			} // for
				//
		} // if
	...
	@Test
	void testToMultimap6() throws Throwable {
		//
		final Iterable<Cell<String, String, String>> cellSet = TableUtil
				.cellSet(ImmutableTable.of("奈良奥山ドライブウェイ （奈良奥山ドライブコース） （新若草山コース） （高円山コース）",
		...
		if (cellSet != null && cellSet.iterator() != null) {
			...
			for (final Cell<String, String, String> cell : cellSet) {
				...
				if (cell == null) {
					...
					//
				Assertions.assertEquals(cell.getValue(),
						Util.toString(toMultimap6(cell.getRowKey(), cell.getColumnKey())), Util.toString(cell));
				//
			} // for
				//
		} // if
	...
	private static Multimap<String, String> toMultimap6(final String s1, final String s2) throws Throwable {
		try {
			final Object obj = METHOD_TO_MULTI_MAP6.invoke(null, s1, s2);
			if (obj == null) {
				return null;
			} else if (obj instanceof Multimap) {
				return (Multimap) obj;
	...
	@Test
	void testToMultimap7() throws Throwable {
		//
		final Iterable<Cell<String, String, String>> cellSet = TableUtil
				.cellSet(ImmutableTable.of("三才山トンネル有料道路", "みさやまとんねるゆうりょうどうろ", "{三才山=[みさやま], 有料道路=[ゆうりょうどうろ]}"));
		//
		if (cellSet != null && cellSet.iterator() != null) {
			//
			for (final Cell<String, String, String> cell : cellSet) {
				...
				if (cell == null) {
					...
					//
				Assertions.assertEquals(cell.getValue(),
						Util.toString(toMultimap7(cell.getRowKey(), cell.getColumnKey())), Util.toString(cell));
				//
			} // for
				//
		} // if
	...
	private static Multimap<String, String> toMultimap7(final String s1, final String s2) throws Throwable {
		try {
			final Object obj = METHOD_TO_MULTI_MAP7.invoke(null, s1, s2);
			if (obj == null) {
				return null;
			} else if (obj instanceof Multimap) {
				return (Multimap) obj;
	...
	@Test
	void testToMultimap9() throws Throwable {
		//
		final Iterable<Cell<String, String, String>> cellSet = TableUtil
				.cellSet(ImmutableTable.of("銚子新大橋有料道路 （利根かもめ大橋有料道路）", "ちょうししんおおはしゆうりょうどうろ （とねかもめおおはしゆうりょうどうろ）",
		...
		if (cellSet != null && cellSet.iterator() != null) {
			...
			for (final Cell<String, String, String> cell : cellSet) {
				...
				if (cell == null) {
					...
					//
				Assertions.assertEquals(cell.getValue(),
						Util.toString(toMultimap9(cell.getRowKey(), cell.getColumnKey())), Util.toString(cell));
				//
			} // for
				//
		} // if
	...
	private static Multimap<String, String> toMultimap9(final String s1, final String s2) throws Throwable {
		try {
			final Object obj = METHOD_TO_MULTI_MAP9.invoke(null, s1, s2);
			if (obj == null) {
				return null;
			} else if (obj instanceof Multimap) {
				return (Multimap) obj;
	...
	@Test
	void testToMultimap10() throws Throwable {
		//
		final Iterable<Cell<String, String, String>> cellSet = TableUtil.cellSet(ImmutableTable.of("六甲有料道路 （六甲トンネル線）",
				"ろっこうゆうりょうどうろ （ろっこうとんねるせん）", "{六甲有料道路=[ろっこうゆうりょうどうろ], 六甲=[ろっこう], 線=[せん]}"));
		//
		if (cellSet != null && cellSet.iterator() != null) {
			//
			for (final Cell<String, String, String> cell : cellSet) {
				...
				if (cell == null) {
					...
					//
				Assertions.assertEquals(cell.getValue(),
						Util.toString(toMultimap10(cell.getRowKey(), cell.getColumnKey())), Util.toString(cell));
				//
			} // for
				//
		} // if
	...
	private static Multimap<String, String> toMultimap10(final String s1, final String s2) throws Throwable {
		try {
			final Object obj = METHOD_TO_MULTI_MAP10.invoke(null, s1, s2);
			if (obj == null) {
				return null;
			} else if (obj instanceof Multimap) {
				return (Multimap) obj;
