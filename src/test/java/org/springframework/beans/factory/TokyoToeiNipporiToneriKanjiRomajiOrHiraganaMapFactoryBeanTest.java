...
class TokyoToeiNipporiToneriKanjiRomajiOrHiraganaMapFactoryBeanTest {
	...
	private TokyoToeiNipporiToneriKanjiRomajiOrHiraganaMapFactoryBean instance = null;

	@BeforeEach
	void beforeEach() {
		//
		instance = new TokyoToeiNipporiToneriKanjiRomajiOrHiraganaMapFactoryBean();
		//
	}
	...
	void testSetUnicodeBlock() throws Throwable {
		//
		final Field unicodeBlock = TokyoToeiNipporiToneriKanjiRomajiOrHiraganaMapFactoryBean.class
