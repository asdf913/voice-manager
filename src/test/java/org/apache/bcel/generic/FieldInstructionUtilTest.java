...
class FieldInstructionUtilTest {
		...
		public Object invoke(final Object self, final Method thisMethod, final Method proceed, final Object[] args)
			...
			if (self instanceof ConstantPoolGen) {
				...
				if (Objects.equals(methodName, "getConstantPool")) {
					...
					//
			} else if (self instanceof FieldInstruction && Objects.equals(methodName, "getFieldName")) {
				//
				return null;
				//
			} // if
	...
	void testNull() {
		//
		final Method[] ms = FieldInstructionUtil.class.getDeclaredMethods();
		//
		Method m = null;
		//
	...
	void testGetFieldName() throws Throwable {
		...
		//
		Assertions
				.assertNull(FieldInstructionUtil.getFieldName(ProxyUtil.createProxy(FieldInstruction.class, mh), null));
		//
		...
		for (final ClassInfo classInfo : classInfos) {
			...
			try {
				//
				if (isAssignableFrom(FieldInstruction.class, Class.forName(name = HasNameUtil.getName(classInfo)))
						&& !(clz = Class.forName(name)).isInterface() && !Modifier.isAbstract(clz.getModifiers())) {
					//
					final FieldInstruction fi = cast(FieldInstruction.class, Narcissus.allocateInstance(clz));
					//
					System.out.println(name);
					//
					Assertions.assertNull(FieldInstructionUtil.getFieldName(fi, null), name);
					//
					Assertions.assertNull(FieldInstructionUtil.getFieldName(fi,
