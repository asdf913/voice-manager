...
public interface MultimapUtil {
	...
	static boolean isEmpty(@Nullable final Multimap<?, ?> instance) {
	...
	static boolean containsKey(@Nullable final Multimap<?, ?> instance, @Nullable final Object key) {
		return instance != null && instance.containsKey(key);
	}

	static void remove(@Nullable final Multimap<?, ?> instance, final Object key, final Object value) {
		if (instance != null) {
