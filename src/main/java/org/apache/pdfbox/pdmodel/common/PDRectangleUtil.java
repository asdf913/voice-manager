...
public interface PDRectangleUtil {

	static float getWidth(final PDRectangle instance) {
		//
		final List<Field> fs = toList(
				filter(testAndApply(Objects::nonNull, getDeclaredFields(getClass(instance)), Arrays::stream, null),
						x -> Objects.equals(getName(x), "rectArray")));
		//
	...
	static float getHeight(final PDRectangle instance) {
		//
		final List<Field> fs = toList(
				filter(testAndApply(Objects::nonNull, getDeclaredFields(getClass(instance)), Arrays::stream, null),
						x -> Objects.equals(getName(x), "rectArray")));
